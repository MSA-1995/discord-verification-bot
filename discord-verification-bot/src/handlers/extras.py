...
WELCOME_CHANNEL_ID = os.getenv("WELCOME_CHANNEL_ID", "1545884039897157652")
...
class Extras(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        welcome_channel = guild.get_channel(int(WELCOME_CHANNEL_ID)) if WELCOME_CHANNEL_ID.isdigit() else None
